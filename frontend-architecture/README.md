...
Modern web frontends are fully fledged client-side applications running on distributed, heterogeneous user devices. This section covers rendering strategies, state management, micro-frontends, bundlers, meta-frameworks, CSS architecture, design systems, performance, testing, and more.
...
3. [Modern/Web Patterns](./modern-web-patterns.md) — Module, Mixin, Provider
4. [Micro-frontends](./micro-frontends/README.md) — Module Federation, Iframe, Web Components
